 ...
 * 
 * Run this file to see put throttling.
 * 
 * At beginning, the put requests are processed although the volume beyond write capacity.
 * After a while, the put requests are slower. But not lots of put requests are throttled.
 * It might because that the SDK exponential backoff of the automatic retry.
 */
public class AmazonDynamoDBSample_PutThrottled {
	 ...
	 * default location (/Users/haifengw/.aws/credentials) where the sample code
